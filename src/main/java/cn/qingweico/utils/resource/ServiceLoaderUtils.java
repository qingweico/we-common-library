package cn.qingweico.utils.resource;
...
public abstract class ServiceLoaderUtils {
     ...
     * path下的配置文件/META-INF/services/ <code>serviceInterfaceType</code>
     * 每个service interface type 的配置文件可以定义多个实现类列表
     * <p/>
     *
     * @param <T>
     ...
     *         中的话,将会抛出 IllegalArgumentException0
     */
