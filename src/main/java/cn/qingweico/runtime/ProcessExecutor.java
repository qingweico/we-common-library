...
public class ProcessExecutor {
     ...
     * <p/>
     *
     * @param outputStream          output stream for a process normal or error input stream.
     * @param timeoutInMilliseconds millisecond timeout
     * @throws IOException      if process execution is failed.
